...
export function saveAs(
  currentFile,
  setCurrentFile, fileChange, setLines, setHighlightedLines, setSelectedLines, lines, cols, setActionMessage,
) {
  ...
  if (filePath) { // if user cancelled, filePath is undefined
    save(filePath, setLines, setHighlightedLines, setSelectedLines, lines, cols, setActionMessage)
      .then(() => {
...
export function open(
  currentFile, setCurrentFile, fileChange, setLines, setHighlightedLines, setSelectedLines, setActionMessage, cols,
) {
